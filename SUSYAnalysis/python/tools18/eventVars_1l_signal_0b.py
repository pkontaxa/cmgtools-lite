...
xsecFile = "../python/tools18/glu_xsecs_13TeV.txt"

cntsSusy = {} # dict for signal counts
C_ISRweightsSusy = {}
cntFileT1 = "../python/tools18/t1ttt_scan_counts.txt"
...
ISRweightFile = "../python/tools18/ISRnormWeightsT5qqqqWW_18_final.txt"
