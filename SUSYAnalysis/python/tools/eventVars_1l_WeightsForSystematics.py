...
class EventVars1LWeightsForSystematics:
    ...
    def __call__(self,event,base={}):
        ...
        ### for multi-b
        constVariation= sqrt(0.11*0.11 + 0.01*0.01)
        slopevariation = sqrt(0.03*0.03 + 0.01*0.01)
        wmean = 5.81 - 0.5
        ###############

        ### for 0-b
        constVariation_0b= sqrt(0.39*0.39 + 0.02*0.02)
        slopevariation_0b = sqrt(0.09*0.09 + 0.02*0.02)
        wmean_0b = 5.06 - 0.5
        ###############
...
#        if (event.ngenLep+event.ngenTau)==2: #would like to restore this behavior...
        if sumnGenLepTau==2:
            ret['DilepNJetCorr']          = 1.11-0.03*(nJets30Clean-wmean)
            ...
            ret['DilepNJetCorr_0b']          = 1.39-0.09*(nJets30Clean-wmean_0b)
