...
# Electrons
# Full-Sim to data
f1_full_ele = TFile.Open('ElectronScaleFactors_Run2016.root', 'read')

h1_full_ele = f1_full_ele.Get('Run2016_CutBasedTightNoIso94XV2')
h2_full_ele = f1_full_ele.Get('Run2016_Mini')
