...
#ISRweightFile = "../python/tools/ISRnormWeightsT5qqqqWW_16v2.txt"
ISRweightFile = "../python/tools/ISRnormWeightsT5qqqqWW_16_final.txt"
#ISRweightFile = "ISRnormWeightsT5qqqqWW_16v2.txt"

cntFileT5 = "../python/tools/t5qqqq_scan_counts.txt"
#cntFileT5 = "../python/tools/t5qqqq_scan_counts_shortened16.txt"
#cntFileT5 = "t5qqqq_scan_counts.txt"
    ...
    def __call__(self,event,base):
        ...
        if (not event.isData and "T5qqqq" in self.sample ) :
            ...
            if "T5qqqq" in self.sample :
                ...
                print("debug", C_ISR, C_ISR_up, C_ISR_down)
                ...
                print "debug2", nISR, nISRweight, nISRweightsyst_up, nISRweightsyst_down
                ###Get ISR stuff
