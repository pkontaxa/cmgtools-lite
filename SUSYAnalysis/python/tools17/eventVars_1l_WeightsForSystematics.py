...
class EventVars1LWeightsForSystematics:
    ...
    def __call__(self,event,base={}):
        ...
        ### for multi-b
        constVariation= sqrt(0.00*0.00 + 0.01*0.01)
        slopevariation = sqrt(0.02*0.02 + 0.01*0.01)
        wmean = 5.73 - 0.5
        ###############

        ### for 0-b
        constVariation_0b= sqrt(0.21*0.21 + 0.02*0.02)
        slopevariation_0b = sqrt(0.08*0.08 + 0.01*0.01)
        wmean_0b = 5.10 - 0.5
        ###############
...
#        if (event.ngenLep+event.ngenTau)==2: #would like to restore this behavior...
        if sumnGenLepTau==2:
            ret['DilepNJetCorr']          = 1.00+0.02*(nJets30Clean-wmean)
            ...
            ret['DilepNJetCorr_0b']          = 1.21-0.08*(nJets30Clean-wmean_0b)
