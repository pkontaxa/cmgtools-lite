...
# Electrons
# Full-Sim to data
f1_full_ele = TFile.Open('ElectronScaleFactors_Run2017.root', 'read')

h1_full_ele = f1_full_ele.Get('Run2017_CutBasedTightNoIso94XV2')
h2_full_ele = f1_full_ele.Get('Run2017_MVAVLooseTightIP2DMini')
...
f1_fast_ele = TFile.Open('detailed_ele_full_fast_sf_17.root', 'read')
f2_fast_ele = TFile.Open('detailed_ele_full_fast_sf_17.root', 'read')
...
f2_full_mu = TFile.Open('detailed_mu_full_fast_sf_17.root', 'read')
...
# Fast-Sim to Full-Sim
f1_fast_mu = TFile.Open('detailed_mu_full_fast_sf_17.root', 'read')
f2_fast_mu = TFile.Open('detailed_mu_full_fast_sf_17.root', 'read')
