...
// ----------------------------------------------------------------------------------------------
//
int TMVA_1lep_CMG_v4(TString myMethodList = "" ){
   ...
   TString outfileName( "TMVASignalBackground_CMG_v6_comp.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
   // ____________
   TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification", outputFile, factoryOptions );
   TMVA::DataLoader *dataloader=new TMVA::DataLoader("datasetBkg_v6_comp");
...
int main( int argc, char** argv )
{
   ...
   return TMVA_1lep_CMG_v4(methodList);
}
