...
// ----------------------------------------------------------------------------------------------
//
int TMVA_1lep_CMG_v3(TString myMethodList = "" ){
   ...
   if (myMethodList != "") {
      ...
      for (UInt_t i=0; i<mlist.size(); i++) {
		...
		string inputFolder = "./Friends_for_MVA/training_uncomp/";
   ...
   TString outfileName( "TMVASignalBackground_CMG_v6_uncomp.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
   // ____________
   TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification", outputFile, factoryOptions );
   TMVA::DataLoader *dataloader=new TMVA::DataLoader("datasetBkg_v6_uncomp");
   ...
   TCut mycuts = "((mGo == 1950 && mLSP == 100) || (mGo == 1950 && mLSP == 200) || (mGo == 1900 && mLSP == 100) || (mGo == 1900 && mLSP == 200)|| (mGo == 1850 && mLSP == 100)|| (mGo == 1850 && mLSP == 200)) && nLep == 1 && Lep_pt > 25 && Selected == 1 &&  nVeto == 0 && nJets30Clean >= 3 && Jet2_pt > 80 &&  HT > 500 && LT > 250 "; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
...
int main( int argc, char** argv )
{
   ...
   return TMVA_1lep_CMG_v3(methodList);
}
