...
// ----------------------------------------------------------------------------------------------
//
int TMVA_1lep_CMG_v6_3(TString myMethodList = "" ){
   ...
   TString outfileName( "TMVA_OUT_SMS_T1tttt_1p9_0p1_topkin_dphiMTout.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
   // ____________
   TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification", outputFile, factoryOptions );
   TMVA::DataLoader *dataloader = new TMVA::DataLoader("TMVA_OUT_SMS_T1tttt_1p9_0p1_topkin_dphiMTout");
   ...
   dataloader->AddVariable("nDeepTop_loose"  ,"nDeepTop_loose"  ,"",'F');
	...
	TString SMS_T1tttt_TuneCUETP8M1_2="signals_forMVA/1900_100.root";
   ...
   dataloader->SetSignalWeightExpression( "0.00163547" );
...
int main( int argc, char** argv )
{
   ...
   return TMVA_1lep_CMG_v6_3(methodList);
}
