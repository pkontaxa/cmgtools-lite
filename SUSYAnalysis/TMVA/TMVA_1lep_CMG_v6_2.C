...
// ----------------------------------------------------------------------------------------------
//
int TMVA_1lep_CMG_v6_2(TString myMethodList = "" ){
   ...
   if (myMethodList != "") {
      ...
      for (UInt_t i=0; i<mlist.size(); i++) {
		...
		string inputFolder = "/nfs/dust/cms/user/amohamed/susy-desy/deepAK8/CMSSW_9_4_11/src/CMGTools/SUSYAnalysis/TMVA/TMVA_Friends_withnosplit/";
	
   Double_t signalWeight      = 1.0;
   Double_t backgroundWeight = 1.0;
   Double_t lumi=35.9 ;
   // Create a new root output file.
   TString outfileName("TMVA_OUT_SMS_T1tttt_1p5_1p0_topkin_dphiMTout.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
   // ____________
   TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification", outputFile, factoryOptions );
   TMVA::DataLoader *dataloader = new TMVA::DataLoader("TMVA_OUT_SMS_T1tttt_1p5_1p0_topkin_dphiMTout");
   ...
   dataloader->AddVariable("nDeepTop_loose"  ,"nDeepTop_loose"  ,"",'F');
	...
	TString SMS_T1tttt_TuneCUETP8M1_2="signals_forMVA/1500_1000.root";
   ...
   dataloader->SetSignalWeightExpression( "0.01419030" );
...
int main( int argc, char** argv )
{
   ...
   return TMVA_1lep_CMG_v6_2(methodList);
}
