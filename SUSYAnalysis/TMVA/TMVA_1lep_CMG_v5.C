...
// ----------------------------------------------------------------------------------------------
//
int TMVA_1lep_CMG_v5(TString myMethodList = "" ){
   ...
   TString outfileName( "TMVASignalBackground_CMG_v6_DNNC.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
   // ____________
   TMVA::Factory *factory = new TMVA::Factory( "TMVAClassification", outputFile, factoryOptions );
   TMVA::DataLoader *dataloader=new TMVA::DataLoader("datasetBkg_v6_DNNC");
   ...
   //dataloader->AddSpectator( "spec2 := var1*3",  "Spectator 2", "units", 'F' );
	...
	dataloader->AddSignalTree    ( tree_SMS_T1tttt_TuneCUETP8M1_1,     3409703);
	dataloader->AddSignalTree    ( tree_SMS_T1tttt_TuneCUETP8M1_2,     4037701);
   ...
   dataloader->SetSignalWeightExpression( "susyXsec/susyNgen" );
   //     factory->SetBackgroundWeightExpression("weight");
   TCut mycuts = "((mGo == 1750 && mLSP == 950) || (mGo == 1750 && mLSP == 1000) ||(mGo == 1750 && mLSP == 1100) ||(mGo == 1750 && mLSP == 1150)|| (mGo == 1700 && mLSP == 1050) || (mGo == 1700 && mLSP == 1100)|| (mGo == 1850 && mLSP == 1000)|| (mGo == 1850 && mLSP == 1050) || (mGo == 1800 && mLSP == 1050) || (mGo == 1650 && mLSP == 1050)||(mGo == 1900 && mLSP == 1000)) && nLep == 1 && Lep_pt > 25 && Selected == 1 &&  nVeto == 0 && nJets30Clean >= 3 && Jet2_pt > 80 &&  HT > 500 && LT > 250 "; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
   ...
   if (Use["DNN_CPU"] or Use["DNN_GPU"] or Use["DNN"]) {
      // General layout.
      //TString layoutString ("Layout=TANH|128,TANH|128,TANH|128,LINEAR");
      TString layoutString ("Layout=RELU|100,RELU|100,SIGMOID");
      ...
      TString training2("LearningRate=1e-3,Momentum=0.0,Repetitions=1,"
                        ...
                        "WeightDecay=1e-4,Regularization=L2,"
                        "DropConfig=0.0+0.0+0.0+0.0, Multithreading=True");*/
      TString training0 ("LearningRate=1e-1,Momentum=0.0,Repetitions=1,ConvergenceSteps=50,BatchSize=20,TestRepetitions=15,WeightDecay=0.001,Regularization=NONE,DropConfig=0.0+0.5+0.5+0.5,DropRepetitions=1,Multithreading=True");
      ...
      if (Use["DNN"]){
		 TString cpuOptions = dnnOptions + ":Architecture=CPU";
		 factory->BookMethod(dataloader, TMVA::Types::kDNN, "DNN", cpuOptions ); // NN
	 }
   }
...
int main( int argc, char** argv )
{
   ...
   return TMVA_1lep_CMG_v5(methodList);
}
