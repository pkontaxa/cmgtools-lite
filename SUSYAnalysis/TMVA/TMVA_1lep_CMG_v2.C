...
void TMVA_1lep_CMG_v2(){
   ...
   TCut mycuts = "((mGo == 1900 && mLSP == 100) || (mGo == 1800 && mLSP == 100) || (mGo == 1700 && mLSP == 100) || (mGo == 1600 && mLSP == 100)) && nLep == 1 && Lep_pt > 25 && Selected == 1 &&  nVeto == 0 && nJets30Clean >= 3 && Jet2_pt > 80 &&  HT > 500 && LT > 250 "; // for example: TCut mycuts = "abs(var1)<0.5 && abs(var2-0.5)<1";
