...
void mergeHists_0b(){
    ...
    TFile *f2016 = TFile::Open("/nfs/dust/cms/user/pakontax/CMSSW/Full_Run_II_Analysis_FINAL_FINAL_FINAL_17July2020/CMSSW_10_4_0/src/CMGTools/TTHAnalysis/python/plotter/susy-1lep/DLCRStudies/Output/zero-b/dPhi0p5/2016/1L_ForDL_plots.root");
    TFile *f2017 = TFile::Open("/nfs/dust/cms/user/pakontax/CMSSW/Full_Run_II_Analysis_FINAL_FINAL_FINAL_17July2020/CMSSW_10_4_0/src/CMGTools/TTHAnalysis/python/plotter/susy-1lep/DLCRStudies/Output/zero-b/dPhi0p5/2017/1L_ForDL_plots.root");
    TFile *f2018 = TFile::Open("/nfs/dust/cms/user/pakontax/CMSSW/Full_Run_II_Analysis_FINAL_FINAL_FINAL_17July2020/CMSSW_10_4_0/src/CMGTools/TTHAnalysis/python/plotter/susy-1lep/DLCRStudies/Output/zero-b/dPhi0p5/2018/1L_ForDL_plots.root");


    vector<TString> bkg_list={"background","TTsemiLep","TTdiLep","TTV","SingleT","WJets","VV","DY","QCD","data"};
    
    vector<TString> LT_list={"LTInc","LT1","LT2","LT3","LT4i"};

    const int dir_check=system("stat ./MergedPlots_ROOTFile_0b/dPhi0p5");

    if(dir_check==256){
                const int dir_create = system("mkdir -p ./MergedPlots_ROOTFile_0b/dPhi0p5");
    }

    TFile f_merged("./MergedPlots_ROOTFile_0b/dPhi0p5/merged_histos_1L.root","new");
    ...
    for(unsigned iBkg=0;iBkg<bkg_list.size();++iBkg){
        ...
        hist_2016 = (TH1D*)f2016->Get("nJ_"+LT_list[iLT]+"_"+bkg_list[iBkg]);
        hist_2017 = (TH1D*)f2017->Get("nJ_"+LT_list[iLT]+"_"+bkg_list[iBkg]);
        hist_2018 = (TH1D*)f2018->Get("nJ_"+LT_list[iLT]+"_"+bkg_list[iBkg]);
