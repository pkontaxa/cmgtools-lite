...
Tdir = ["SampLinks_PANTELIS_T5qqqqWW/"] #important needs this format
# MC
mcFTdir = "SampLinks_PANTELIS_T5qqqqWW/Friends/"
sigFTdir = "SampLinks_PANTELIS_T5qqqqWW/Friends/"

# new data
dataFTdir = "SampLinks_PANTELIS_T5qqqqWW/Friends/"
...
#    print mca.listBackgrounds()
    ...
    if not options.pretend and not options.systs:
        ...
        for p in mca.listBackgrounds():
            if p in report and 'TTdiLep' not in p and 'TTsemiLep' not in p and 'TTincl' not in p and 'DiLep_' not in p and 'T5qqqqWW' not in p:
        ...
        labels = ["Up","up","down","Down","EWK","TTdiLep","TTsemiLep","TTincl","T5qqqqWW","Env","RMS"] # labels to ignore
        for name in names:
            for lab in labels:
...
if __name__ == "__main__":
    ...
    if options.conference == "Moriond17":
        ...
        from searchBinsMoriond17_Pantelis_BaseLine_T5qqqqWW_with_NW_V2 import *
