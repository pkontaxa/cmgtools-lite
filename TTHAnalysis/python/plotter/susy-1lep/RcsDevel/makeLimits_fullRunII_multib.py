...
###########################
def combineCards_all_Years(f , s ):
    try:
        os.stat('combinedCardsAllYears')
    except:
        os.mkdir('combinedCardsAllYears')
   
    cmd = 'combineCards.py ../datacardsABCD_TEST_2016_Full_25March2021_NEW_DL_CORRECTIONS_LIGHT/combinedCards/'+ s + '.txt ' + '../datacardsABCD_TEST_2017_Full_25March2021_NEW_DL_CORRECTIONS_LIGHT/combinedCards/'+ s + '.txt ' + '../datacardsABCD_TEST_2018_Full_25March2021_NEW_DL_CORRECTIONS_LIGHT/combinedCards/'+ s + '.txt' + ' > ' + f.replace(s,'combinedCardsAllYears') +'/' + s + '.txt'
    print cmd
    os.system(cmd)
