...
#NB bins with NT
#binsNB['NB0'] = ('nBJet_Excl_LooseTop_08 == 0','$=$ 0')
#binsNB['NB1'] = ('nBJet_Excl_LooseTop_08 == 1','$=$ 1')
#binsNB['NB2'] = ('nBJet_Excl_LooseTop_08 == 2','$=$ 2')
#binsNB['NB12'] = ('nBJet_Excl_LooseTop_08 == 2','[1,2]')
#binsNB['NB0i'] = ('nBJet_Excl_LooseTop_08 >= 0','$\geq$ 0')
#binsNB['NB1i'] = ('nBJet_Excl_LooseTop_08 >=1','$\geq$ 1')
#binsNB['NB2i'] = ('nBJet_Excl_LooseTop_08 >= 2','$\geq$ 2')
#binsNB['NB3i'] = ('nBJet_Excl_LooseTop_08 >= 3','$\geq$ 3')
...
# NT Bins
binsNT = {}
binsNT['NT0'] = ('nTop_Total_Combined == 0','$=$ 0')
binsNT['NT1'] = ('nTop_Total_Combined == 1','$=$ 1')
binsNT['NT2'] = ('nTop_Total_Combined == 2','$=$ 2')
binsNT['NT0i'] = ('nTop_Total_Combined >= 0','$\geq$ 0')
binsNT['NT1i'] = ('nTop_Total_Combined >= 1','$\geq$ 1')
binsNT['NT2i'] = ('nTop_Total_Combined >= 2','$\geq$ 2')
...
def getSRcut(nj_bin, lt_bin, sr_bin, blinded):
    ...
    #Pantelis cuts = { "LT1": 1.0, "LT1i": 1.0, "LT2": 0.75,"LT2i": 0.75, "LT3": 0.75, "LT3i": 0.75, "LT4": 0.5, "LT4i": 0.5 , "LT5i":0.5}
    cuts = { "LT1": 0.75, "LT12": 0.75, "LT1i": 0.75, "LT2": 0.75,"LT2i": 0.75, "LT3": 0.75, "LT3i": 0.75, "LT4": 0.75, "LT4i": 0.75 , "LT5i":0.75} 
        ...
        for lt_bin in ltbins:
            ...
            if nj_bin in ['NJ45f6']:
                if nb_bin == 'NB1i' and lt_bin not in ['LT5i']:
                    if lt_bin not in ['LT4i','LT3']:   
                       htbins+= ['HT03','HT4i']
                    elif lt_bin in ['LT4i','LT3']:
                       htbins+= ['HT03i']

                    ntbins+= ['NT1i']                   

                else:
                    if lt_bin not in ['LT3','LT4i']:                        
                        htbins += ['HT03','HT4i']
            ...
            for ht_bin in htbins:
                ...
                for nt_bin in ntbins:
                       nt_cut = binsNT[nt_bin][0]

                       binname = "%s_%s_%s_%s_%s" %(lt_bin,ht_bin,nb_bin,nj_bin,nt_bin)
                       cutDict[binname] = [("base",lt_bin,lt_cut),("base",ht_bin,ht_cut),("base",nb_bin,nb_cut),("base",nj_bin,nj_cut),("base",nt_bin,nt_cut)]

                       # split to SR/CR
                       for sr_bin in ['SR']:
                            sr_cut = getSRcut(nj_bin, lt_bin, sr_bin, blinded)[0]

                            binname = "%s_%s_%s_%s_%s_%s" %(lt_bin,ht_bin,nb_bin,nj_bin,nt_bin,sr_bin)
                            cutDictSR[binname] = [("base",lt_bin,lt_cut),("base",ht_bin,ht_cut),("base",nb_bin,nb_cut),("base",nj_bin,nj_cut),("base",nt_bin,nt_cut),("base",sr_bin,sr_cut)]

                       for cr_bin in ['CR']:
                            cr_cut = getSRcut(nj_bin, lt_bin, cr_bin, blinded)[0]
                            binname = "%s_%s_%s_%s_%s_%s" %(lt_bin,ht_bin,nb_bin,nj_bin,nt_bin,cr_bin)
                            cutDictCR[binname] = [("base",lt_bin,lt_cut),("base",ht_bin,ht_cut),("base",nb_bin,nb_cut),("base",nj_bin,nj_cut),("base",nt_bin,nt_cut),("base",cr_bin,cr_cut)]
        ...
        for lt_bin in ltbins:
            ...
            for ht_bin in htbins:
                ...
                for nt_bin in ntbins:
                       ...
                       cutDictf9[binname] = [("base",lt_bin,lt_cut),("base",ht_bin,ht_cut),("base",nb_bin,nb_cut),("base",nj_bin,nj_cut),("base",nt_bin,nt_cut)]
...
# split to SR/CR
                       ...
                       for sr_bin in ['SR']:
                            ...
                            binname = "%s_%s_%s_%s_%s_%s" %(lt_bin,ht_bin,nb_bin,nj_bin,nt_bin,sr_bin)
                            cutDictSRf9[binname] = [("base",lt_bin,lt_cut),("base",ht_bin,ht_cut),("base",nb_bin,nb_cut),("base",nj_bin,nj_cut),("base",nt_bin,nt_cut),("base",sr_bin,sr_cut)]

                       for cr_bin in ['CR']:
                            cr_cut = getSRcut(nj_bin, lt_bin, cr_bin, blinded)[0]

                            binname = "%s_%s_%s_%s_%s_%s" %(lt_bin,ht_bin,nb_bin,nj_bin,nt_bin,cr_bin)
                            cutDictCRf9[binname] = [("base",lt_bin,lt_cut),("base",ht_bin,ht_cut),("base",nb_bin,nb_cut),("base",nj_bin,nj_cut),("base",nt_bin,nt_cut),("base",cr_bin,cr_cut)]
