...
def findMatchBins(binname):
    ...
    SBname = SBname[:SBname.find('_NJ')] + '_' + njSB + SBname[SBname.find('_NT'):]
    split_SBname = SBname.rsplit('_',1)
    #print "SBname Pantelis: ", split_SBname[0]
    SR_SBname = split_SBname[0] + '_SR'
    CR_SBname = split_SBname[0] + '_CR'
    DLCR_SBname = split_SBname[0] + '_DLCR'
...
def writeBins(ofname, srcdir, binnames):
    ...
    for idx,dname in enumerate(dirnames):
        ...
        #print "srcfname Pantelis: ", srcfname 
