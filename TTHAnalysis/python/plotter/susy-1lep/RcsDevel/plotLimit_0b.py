...
#    os.chdir(pattern)
    ...
    if 1==1:
        ...
        hlim.Write("T5qqqqWWObservedExcludedXsec");
        cobs.Write("T5qqqqWWObservedLimit");
        cobsup.Write("T5qqqqWWObservedLimitDown");
        cobsdown.Write("T5qqqqWWObservedLimitUp");
        cexp.Write("T5qqqqWWExpectedLimit");
        cup.Write("T5qqqqWWExpectedLimitDown");
        cdown.Write("T5qqqqWWExpectedLimitUp");
