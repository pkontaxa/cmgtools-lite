...
legend_ = None;
def doLegend(pmap,mca,corner="TR",textSize=0.035,cutoff=0.0,cutoffSignals=True,mcStyle="F",legWidth=0.18,legBorder=True,signalPlotScale=None,totalError=None,header="",doWide=False,sf=None,columns=1):
