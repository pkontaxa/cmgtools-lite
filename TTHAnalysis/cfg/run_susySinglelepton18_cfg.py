...
if test == '1':
    ...
    if what == "TTLep":
        ...
        TTLep_pow.files = [ 'root://cms-xrd-global.cern.ch//store/mc/RunIIFall17MiniAOD/TTTo2L2Nu_mtop166p5_TuneCP5_PSweights_13TeV-powheg-pythia8/MINIAODSIM/94X_mc2017_realistic_v10-v1/00000/04FA0180-A9F1-E711-9BD7-0CC47A6C115A.root' ]
        selectedComponents = [ TTLep_pow ]
    elif what == "TTSemi":
